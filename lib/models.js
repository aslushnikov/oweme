...
module.exports = function(db, callback) {
    ...
    var User = db.define("user", {
        ...
        validations: {
            ...
            password: orm.validators.password("luns6", "Password can have only lowercase letters, uppercase letters, numbers, special characters and a minimum length of 6."),
        },
        methods: {
            fullName: function() {
